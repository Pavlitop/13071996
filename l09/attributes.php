...
$users = [
    ['name' => 'Pavlo', 'age' => 32, 'gender' => 'male'],
    ['name' => 'Andrew', 'age' => 33, 'gender' => 'male'],
    ['name' => 'Vlad', 'age' => 34, 'gender' => 'male', 'greeting' => 'Hi'],
    ['name' => 'Oleg', 'age' => 35, 'gender' => 'male'],
...
//    var_dump(func_num_args(), func_get_args());
    echo $message, array_sum(func_get_args()), '<br>';
}

oldSum('Tada!', 1, 3, 5, 6, 7, 12, 21);
